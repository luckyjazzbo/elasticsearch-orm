...
RSpec.describe Mes::Elastic::Response do
  ...
  describe 'querying some fields' do
    let(:mocked_response) do
      {
        'took' => 12,
        'timed_out' => false,
    ...
    it 'uses fields from hit.fields' do
      expect(response.first.attributes).to eq(
        'id' => '9084eddf-4a48-4e39-afbd-6f3e4e4dc7c5',
        'field' => 'Hello',
        'nested' => {
          'field' => 'World',
          'other_field' => '!!',

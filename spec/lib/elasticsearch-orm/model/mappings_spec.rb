...
RSpec.describe 'Mappings' do
  ...
  describe '.field' do
    ...
    it 'fails to create field with reserved names' do
      expect { test_model.field :send, :text }
        .to raise_error ElasticsearchOrm::Model::UnpermittedFieldNameError
    end
  end
  ...
  describe '.object' do
    ...
    context 'when shallow' do
      subject do
        class ShallowObjectTestModel < ElasticsearchOrm::Model
        ...
        config_test_model_class ShallowObjectTestModel
      end
    ...
    context 'when nested' do
      subject do
        class NestedObjectTestModel < ElasticsearchOrm::Model
          object :object_field do
        ...
        config_test_model_class NestedObjectTestModel
      end
  ...
  describe '.new' do
    ...
    it 'allows fields from mapping on creating new instance' do
      expect { test_model.new(correct_field: 'value') }
        .not_to raise_error # ElasticsearchOrm::Model::UnpermittedAttributeError
    end
    ...
    context 'with permitting only defined attributes' do
      it 'rejects params which do not appear in mapping on creating new instance' do
        expect { test_model.new(wrong_field: 'value') }
          .to raise_error ElasticsearchOrm::Model::UnpermittedAttributeError
      end
  ...
  describe '.multilang_field' do
    ...
    let(:multilang_mapping) do
      ElasticsearchOrm::Model::LanguageAnalyzer::LANGUAGE_ANALYZERS
    ...
    it 'defines fields with fields within' do
      expect do
        subject.multilang_field :titles,
          type: :text,
          fields: { autocomplete: { type: :text, analyzer: :english, lang_opts: { de: { analyzer: :german } } } }
      ...
      expect(subject.mapping).to eq(
        ...
        properties: {
          id: { type: :keyword },
          titles: {
            properties: ElasticsearchOrm::Model::LanguageAnalyzer::LANGUAGE_ANALYZERS
